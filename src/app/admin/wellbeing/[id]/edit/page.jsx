...
export default function EditWellbeingTopicPage() {
    ...
    const fetchTopic = async () => {
        try {
            const response = await api.get(`/wellbeing/admin/${params.id}`);
            const topic = response.data;
            setFormData({
                title: topic.title || '',
                shortDescription: topic.shortDescription || '',
                icon: topic.icon || '',
                order: topic.order?.toString() || '0',
    ...
    const handleSubmit = async (e) => {
        ...
        setError('');
        try {
            await api.put(`/wellbeing/admin/${params.id}`, {
                ...formData,
    ...
    return (
        <div style={{ padding: '32px', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ color: '#6b7280', marginBottom: '32px' }}>
                Update wellness dimension content
            </p>
